export default function ToS() {
  return (
    <div>
      ...
      <div class="w-[90%] md:w-[60%] lg:w-1/2 mx-auto mb-6">
        <p>
          <strong>OVERVIEW</strong> <br /> This website is operated by Auto
          Trading Genius. Throughout the site, the terms &quot;we&quot;,
          &quot;us&quot; and &quot;our&quot; refer to Auto Trading Genius. Auto
          Trading Genius offers this website, including all information, tools
          ...
          stated here. <br /> <br /> By visiting our site and/ or purchasing
          ...
          this site. <br /> You may not use our products for any illegal or
          ...
          laws). <br /> You must not transmit any worms or viruses or any code
          of a destructive nature. <br /> A breach or violation of any of the
          Terms will result in an immediate termination of your Services. <br />{' '}
          <br /> <strong>SECTION 2 - GENERAL CONDITIONS</strong> <br /> We
          ...
          and will not limit or otherwise affect these Terms. <br /> <br />{' '}
          <strong>
          ...
          Service made on this site is void where prohibited. <br /> We do not
          warrant that the quality of any products, Services, information, or
          ...
          <br /> <br /> You agree to provide current, complete and accurate
          ...
          needed. <br /> <br /> For more details, please review our Refund
          Policy
          <br /> <br /> <strong>SECTION 7 - OPTIONAL TOOLS</strong> <br /> We
          may provide you with access to third-party tools over which we neither
          monitor nor have any control nor input. <br /> You acknowledge and
          ...
          third-party tools. <br /> Any use by you of the optional tools offered
          ...
          from third-parties. <br /> Third-party links on this site may direct
          you to third-party websites that are not affiliated with us. We are
          ...
          other materials, products, or Services of third-parties. <br /> We are
          not liable for any harm or damages related to the purchase or use of
          ...
          <br /> <br /> <strong>SECTION 10 - PERSONAL INFORMATION</strong>{' '}
          <br /> Your submission of personal information through the store is
        ...
        <p>
          ...
          <br /> <br /> <strong>SECTION 12 - PROHIBITED USES</strong> <br /> In
          ...
          the Service will be accurate or reliable. <br /> You agree that from
          time to time we may remove the Service for indefinite periods of time
          or cancel the Service at any time, without notice to you. <br /> You
          expressly agree that your use of, or inability to use, the Service is
          at your sole risk. The Service and all products and Services delivered
          to you through the Service are (except as expressly stated by us)
          ...
          particular purpose, durability, title, and non-infringement. <br /> In
          no case shall Auto Trading Genius, our directors, officers, employees,
          ...
          indemnify, defend and hold harmless Auto Trading Genius and our
          ...
          or the rights of a third-party. <br /> <br />{' '}
          <strong>SECTION 15 - SEVERABILITY</strong> <br /> In the event that
          ...
          <br /> These Terms of Service are effective unless and until
          ...
          Services, or when you cease using our site. <br /> If in our sole
          ...
          this agreement at any time without notice and you will remain liable
          ...
          thereof). <br /> <br /> <strong>SECTION 17 - ENTIRE AGREEMENT</strong>{' '}
          <br /> The failure of us to exercise or enforce any right or provision
          of these Terms of Service shall not constitute a waiver of such right
          ...
          prior versions of the Terms of Service). <br /> Any ambiguities in the
          ...
          Brazil. <br /> <br />{' '}
          <strong>SECTION 19 - CHANGES TO TERMS OF SERVICE</strong> <br /> You
