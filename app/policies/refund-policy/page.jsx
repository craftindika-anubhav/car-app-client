        ...
        <div class="w-[90%] md:w-[60%] lg:w-1/2 mx-auto mb-6">
          <div class="rte">
            <p>
              ...
              <a href="mailto:contact@autotradinggenius.com">
                contact@autotradinggenius.com
              </a>
              . Please note that returns will need to be sent to the following
              address: Praia de Botafogo 501, Bloco A, Rio de Janeiro, RJ
              22250-040 Brasil
              <br />
              <br />
            ...
            <p>
              ...
              (such as products). We also do not accept returns for hazardous
              materials, flammable liquids, or gases. Please get in touch if you
              have questions or concerns about your specific item. <br />
              <br />
            ...
            <p>
              ...
              your return, please contact us at contact@autotradinggenius.com.
            </p>
          </div>
        </div>
      </div>
